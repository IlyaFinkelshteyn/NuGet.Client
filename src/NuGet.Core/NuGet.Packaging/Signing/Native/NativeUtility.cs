            ...
            if (attributes.Count != 0)
            {
                ...
                checked
                {
                    ...
                    foreach (var attribute in attributes)
                    {
                        ...
                        attributeIndex->pszObjId = hb.AllocAsciiString(attribute.Oid.Value);
                        attributeIndex->cValue = (uint)attribute.Values.Count;
                        attributeIndex->rgValue = (IntPtr)dataBlob;
